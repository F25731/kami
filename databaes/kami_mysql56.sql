...
CREATE TABLE `orders`  (
  ...
  `project_id` bigint NULL DEFAULT NULL COMMENT 'Project ID',
  `source` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'external_shop' COMMENT 'Issuance Source',
  `external_order_no` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'External Order No',
  `package_id` bigint NULL DEFAULT NULL COMMENT 'Package ID',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `pay_time` datetime NULL DEFAULT NULL COMMENT 'Finish Time',
...
INSERT INTO `settings` VALUES (14, 'sender_name', '云逸卡密授权中心');
...
INSERT INTO `settings` VALUES (65, 'systemName', '云逸卡密授权中心');

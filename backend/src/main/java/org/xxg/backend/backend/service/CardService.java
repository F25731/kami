...
public class CardService {
     ...
     */
    @Transactional
    private Card useCardInternal(Long projectId, String cardKey, String deviceId, String ipAddress, Long apiKeyId, String machineCode) {
        // Advanced Card Check
        if (cardKey != null && cardKey.contains("$")) {
             return useAdvancedCard(projectId, cardKey, deviceId, ipAddress, apiKeyId, machineCode);
        }

        Card card = projectId != null ? cardMapper.findByProjectIdAndCardKey(projectId, cardKey) : cardMapper.findByCardKey(cardKey);
        if (card == null) {
    ...
    public Card useCard(String cardKey, String deviceId, String ipAddress, Long apiKeyId, String machineCode) {
        return useCardInternal(null, cardKey, deviceId, ipAddress, apiKeyId, machineCode);
    }

    @Transactional
    public Card useProjectCard(Long projectId, String cardKey, String deviceId, String ipAddress, Long apiKeyId, String machineCode) {
        return useCardInternal(projectId, cardKey, deviceId, ipAddress, apiKeyId, machineCode);
    }
    ...
    public List<Card> createCards(int count, String cardType, int duration, int totalCount,
        ...
        return createCardsForProject(null, count, cardType, duration, totalCount, verifyMethod, encryptionType,
                allowReverify, creatorType, creatorId, creatorName, apiKeyId, stackTimeIfSameMachine, allowSelfUnbind);
    }

    public List<Card> createCardsForProject(Long projectId, int count, String cardType, int duration, int totalCount,
                                 String verifyMethod, String encryptionType, int allowReverify,
                                 String creatorType, Long creatorId, String creatorName, Long apiKeyId,
                                 boolean stackTimeIfSameMachine, boolean allowSelfUnbind) {

        if ("advanced".equalsIgnoreCase(encryptionType)) {
            return createAdvancedCards(projectId, count, totalCount, duration, allowReverify, creatorId, creatorType, creatorName, apiKeyId, stackTimeIfSameMachine, allowSelfUnbind);
        }
    ...
    private List<Card> createAdvancedCards(Long projectId, int count, int totalCount, int duration, int allowReverify, Long creatorId, String creatorType, String creatorName, Long apiKeyId, boolean stackTimeIfSameMachine, boolean allowSelfUnbind) {
    ...
    private Card useAdvancedCard(Long projectId, String fullKey, String deviceId, String ipAddress, Long apiKeyId, String machineCode) {
        try {
